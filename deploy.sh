...
# main config
PLUGINSLUG="payments4g-4geeks-payments"
CURRENTDIR=`pwd`
MAINFILE="gpayments-connector-woocommerce.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/payments4g-4geeks-payments/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="sergiomonge10" # your svn username
